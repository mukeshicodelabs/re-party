...
exports.transactionLineItems = (listing, orderData, providerCommission, customerCommission) => {
  console.log(orderData, 'orderData in transactionLineItems');
  ...
  const unitPrice =
    productType == 'rent' && differenceInDays == 3
...
console.log(orderData, '%%% %%% => orderData');
  ...
  const quantityOrSeats = !!units && !!seats ? { units : differenceInDays === 3 ? 1 : units, seats } : { quantity };
  ...
  const shouldAddDeliveryFee =
    (orderData?.deliveryMethod =='delivery'||orderData?.deliveryMethod =='customDelivery') && orderData?.deliveryfee > 0;
