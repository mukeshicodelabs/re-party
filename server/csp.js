...
const defaultDirectives = {
  ...
  fontSrc: [self, data, 'assets-sharetribecom.sharetribe.com', 'fonts.gstatic.com','cdnjs.cloudflare.com'],
  formAction: [self],
  frameSrc: [
    self,
    '*.stripe.com',
  ...
  styleSrc: [self, unsafeInline, 'fonts.googleapis.com', 'api.mapbox.com','cdnjs.cloudflare.com'],
};
