...
export const initiateOrder = (
  ...
  const orderData = deliveryMethod
    ...
    : { selectedShippingOption, deliveryfee, productType, selectedPricingOption, setupPrice }; 
...
export const speculateTransaction = (
  ...
  const orderData = {
    ...(deliveryMethod
      ? { deliveryMethod, deliveryfee, productType, selectedPricingOption, setupPrice }
      : { deliveryfee, productType, selectedPricingOption, setupPrice }),
