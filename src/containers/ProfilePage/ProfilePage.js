...
export const MainContent = props => {
  ...
  const { communityFavorite, foundingSeller, ecoFriendlyseller, greatCommunicator, partyPro, photoReadyListing, repartyInsider, superhost, topSeller } = currentUser?.attributes?.profile?.publicData || {};
